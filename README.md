This is a C++ implementation of the classic game Battleship, featuring a simple AI opponent. The code can be compiled and run on any machine with a C++ compiler installed.
